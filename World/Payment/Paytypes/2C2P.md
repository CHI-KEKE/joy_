...
11. [後台 Keys 說明](#11-後台-keys-說明)
12. [ChannelCode](#12-channelcode)
...
- **左上角：receiverPubKey** - 加密用，因此 2C2P 會用另外一把解密
- **右下角：PubKey / Private** - 用在簽章解簽章
...
**對照文件**：https://developer.2c2p.com/docs/reference-codes-payment-scheme
