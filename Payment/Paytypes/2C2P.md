...
## TwoCTwoPRefundRequestFinish fail
...
執行　PaymentMiddleWareRefundRequestFinish，購物車序號：1532257  


https://payment-middleware-api-internal.hk.91app.io/api/v1.0/RefundQuery/TwoCTwoP  
...
https://payment-middleware-api-internal.hk.91app.io/api/v1.0/Refund/TwoCTwoP/TG240229L00048  
...
退款時遇到餘額不足 => RefundRequestProcessing  =>  gersalesorder timeout  => 接下來會判斷refund = finish 才回壓大表, 因此執行redo => finish => 目前狀態已正常

42841084-89a8-48bf-b49c-5c61b9f998d7
