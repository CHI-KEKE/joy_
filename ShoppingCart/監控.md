...
# |= `ShopId: 67`
# |=`cammilo@91app.com`
# |=`Successfully got paymentMethodId:`
|=`"Payment\":{\"PayProfileTypeDef\":\"ApplePay\"`
|json
|_props_RequestPath = `/api/checkouts/complete`
 |_props_RequestId=`0HNK8RN8ML153:0000001F`
| line_format "{{._msg}}"
...
```bash
{container=~"cart-web-api|shopping-web-api"}
|json
|= `Api發生錯誤，ShopId:12765`
|json
| line_format "{{._msg}}"
