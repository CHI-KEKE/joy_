...
## 📋 目錄
1. [rule json example](#rule-json-example)
2. [Thresholds](#thresholds)
3. [PromotionEngineService access rule 內容的方法](#promotionengineservice-access-rule-內容的方法)
4. [Item1：productScopePairs](#item1productscopepairs)
5. [Item2：userScopePairs](#item2userscopepairs)
6. [IsBirthdayMonthEnabled](#isbirthdaymonthenabled)
7. [Item3：rewardPointRules / rewardEcouponRules](#item3rewardpointrules--rewardecouponrules)
8. [Item4：rewardPointPeriodType](#item4rewardpointperiodtype)
9. [Item5：calculateTypeDef](#item5calculatetypedef)
10. [Item6：locationScopePairs](#item6locationscopepairs)
...
## PromotionEngineService access rule 內容的方法
...
當月壽星活動會在 rule 的 MatchedUserScopes 有多一個 ，以規則來說它就是一個交集(可能與會員等級併用)
...
## Item3：rewardPointRules  / rewardEcouponRules
