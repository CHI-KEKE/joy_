...
## 生命週期 - 翻譯人員更新了 zh-HK 語系的「PayProfile」
...
https://moiicrm.shop.qa1.my.91dev.tw/webapi/translations/fetch
```
...
https://moiicrm.shop.qa1.my.91dev.tw/webapi/translations/debug/backend.definition.PayProfile.PayProfile_TypeDef_CreditCardInstallment_Razer/zh-TW

可以確認 Remote / Fetch / Project / Module 到底少了甚麼

<br>

### S3

https://sms.pp.91dev.tw/api/translations/debug/backend.entity.promotion_engine_sale_page_ranking.ranking/zh-TW
...
- 清除 menifest redis cache 的 ETag 讓 fetch 可以 work
